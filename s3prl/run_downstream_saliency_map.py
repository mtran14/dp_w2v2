...
from s3prl.downstream.runner_saliency import Runner
...
def get_downstream_args():
    ...
    parser.add_argument('--save_path', default="saliency_maps", help='path to save the saliency maps')
    ...
    if args.past_exp:
        ...
        cannot_overwrite_args = [
            ...
            'backend', 'local_rank', 'past_exp', 'save_path'
        ]
